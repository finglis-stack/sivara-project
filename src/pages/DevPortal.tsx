...
import { Globe, FileText, UserCircle, ShieldCheck, Mail, LifeBuoy } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <Card className="hover:shadow-lg transition-all cursor-pointer border-t-4 border-t-gray-800" onClick={() => navigateToApp('www')}>
            <CardHeader>
              ...
              <CardTitle className="text-lg">Search Engine</CardTitle>
              <CardDescription className="text-xs">sivara.ca</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="hover:shadow-lg transition-all cursor-pointer border-t-4 border-t-blue-600" onClick={() => navigateToApp('docs')}>
            <CardHeader>
              ...
              <CardTitle className="text-lg">Sivara Docs</CardTitle>
              <CardDescription className="text-xs">docs.sivara.ca</CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full">Lancer</Button>
            </CardContent>
          ...
          <Card className="hover:shadow-lg transition-all cursor-pointer border-t-4 border-t-orange-500" onClick={() => navigateToApp('mail')}>
            <CardHeader>
              ...
              <CardTitle className="text-lg">Sivara Mail</CardTitle>
              <CardDescription className="text-xs">mail.sivara.ca</CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full">Lancer</Button>
            </CardContent>
          ...
          {/* Help */}
          <Card className="hover:shadow-lg transition-all cursor-pointer border-t-4 border-t-indigo-600" onClick={() => navigateToApp('help')}>
            <CardHeader>
              <div className="h-12 w-12 bg-indigo-50 rounded-lg flex items-center justify-center mb-2">
                <LifeBuoy className="h-6 w-6 text-indigo-600" />
              </div>
              <CardTitle className="text-lg">Sivara Help</CardTitle>
              <CardDescription className="text-xs">help.sivara.ca</CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full">Lancer</Button>
            </CardContent>
          ...
          <Card className="hover:shadow-lg transition-all cursor-pointer border-t-4 border-t-purple-600" onClick={() => navigateToApp('account')}>
            <CardHeader>
              ...
              <CardTitle className="text-lg">Sivara Account</CardTitle>
              <CardDescription className="text-xs">account.sivara.ca</CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full">Lancer</Button>
            </CardContent>
