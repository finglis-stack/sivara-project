...
const Pricing = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-pink-500 selection:text-white">
      {/* Navbar Transparente - Identique à DocsLanding */}
      ...
      {/* Hero Section Immersive - Identique à DocsLanding */}
      ...
      {/* Section Features épurée - Fond blanc ou gris très clair */}
          ...
          <div className="max-w-4xl mx-auto space-y-24">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-12 group">
                <div className="flex-1 space-y-6">
                    ...
                    <p className="text-xl text-gray-500 font-light leading-relaxed">
                        Obtenez une adresse email personnalisée <strong>@{user?.email ? 'contact' : 'contact'}@votre-entreprise.com</strong>. 
      ...
      <div className="py-24 bg-black text-white">
        <div className="container mx-auto px-6 text-center space-y-8">
          ...
          <p className="text-white/40 text-sm mt-6">Paiement sécurisé. Satisfait ou remboursé.</p>
        </div>
      </div>
    </div>
  );
