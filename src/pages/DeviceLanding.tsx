...
const DeviceLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-blue-900 selection:text-white overflow-x-hidden">
      ...
      {/* Hero Section */}
      <div className="relative min-h-[110vh] flex flex-col justify-start pt-32 lg:pt-48 overflow-hidden">
        {/* Background Image */}
        <div 
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-sm font-medium shadow-lg mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span>
                Disponible en précommande
            </div>
            
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-white mb-6 leading-tight drop-shadow-2xl animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-100">
                La puissance brute. <br/>
                <span className="font-light text-white/90">Sans compromis.</span>
            </h1>
            
            <p className="text-xl text-white/80 font-light max-w-2xl mx-auto mb-10 leading-relaxed drop-shadow-lg animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
        ...
        <div className="relative w-full max-w-5xl mx-auto mt-12 sm:mt-20 z-20 px-4 animate-in fade-in zoom-in duration-1000 delay-500">
            <img 
                src="/sivara-book.png" 
                alt="Sivara Book" 
      ...
      {/* Specs Grid */}
      <div id="specs" className="py-24 bg-white relative z-20 -mt-20 rounded-t-[3rem] shadow-[0_-20px_40px_rgba(0,0,0,0.1)]">
                ...
                <div className="col-span-1 lg:col-span-3 bg-black text-white p-10 rounded-3xl shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                        ...
                        <div className="hidden md:block">
                            {/* Visual representation of screen layers or pixel grid could go here */}
      ...
      <div className="bg-gray-900 py-20 text-center text-white">
        <div className="container mx-auto px-6">
            <h2 className="text-3xl font-bold mb-8">Votre bureau, partout.</h2>
            <Button 
                onClick={handleBuy}
                className="h-14 px-10 bg-white text-black hover:bg-gray-200 rounded-full font-bold shadow-lg"
            >
                Précommander le Sivara Book
            </Button>
            <p className="mt-6 text-sm text-gray-500">Garantie 2 ans incluse. Livraison offerte.</p>
        </div>
      </div>
    </div>
  );
